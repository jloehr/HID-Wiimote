...
#define IOCTL_WIIMOTE_SET_ENABLE_WIIMOTE_XAXIS_ACCELEROMETER	HID_WIIMOTE_BUFFERED_CTL_CODE(0x11)
#define IOCTL_WIIMOTE_SET_ENABLE_WIIMOTE_YAXIS_ACCELEROMETER	HID_WIIMOTE_BUFFERED_CTL_CODE(0x12)
#define IOCTL_WIIMOTE_SET_SWITCH_MOUSEBUTTONS					HID_WIIMOTE_BUFFERED_CTL_CODE(0x13)
#define IOCTL_WIIMOTE_SET_SWITCH_TRIGGERANDSHOULDER				HID_WIIMOTE_BUFFERED_CTL_CODE(0x14)
#define IOCTL_WIIMOTE_SET_SPLIT_TRIGGERAXIS						HID_WIIMOTE_BUFFERED_CTL_CODE(0x15)
#define IOCTL_WIIMOTE_SET_MAP_TRIGGER_AS_AXIS					HID_WIIMOTE_BUFFERED_CTL_CODE(0x16)
#define IOCTL_WIIMOTE_SET_MAP_TRIGGER_AS_BUTTONS				HID_WIIMOTE_BUFFERED_CTL_CODE(0x17)
